...
const ShinningSectionText = () => {
  return (
    <div className="max-w-[640px] flex flex-wrap gap-4 items-center justify-center dark:text-[#ffffff] text-[#000000] pt-16 md:pt-20 mx-auto text-center md:text-[24px] text-[20px] leading-[36px] tracking-[-0.5px] sm:px-0 px-4 pb-2 sm:pb-20">
